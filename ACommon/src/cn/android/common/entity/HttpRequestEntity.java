...
import cn.android.common.util.HttpUtils;

/**
 * <strong>HttpRequest</strong><br/>
 * <ul>
 * <strong>Constructor</strong>
 * <li>{@link HttpRequestEntity#HttpRequest(String)}</li>
 * <li>{@link HttpRequestEntity#HttpRequest(String, Map)}</li>
 * </ul>
 * <ul>
...
public class HttpRequestEntity {
    ...
    public HttpRequestEntity(String url, Map<String, String> parasMap){
        this.url = url;
